...
from super_gradients.training import MultiGPUMode # This is about to be deprecated it looks like

CHECKPOINT_DIR = './checkpoints' # Local path
trainer = Trainer(experiment_name='transfer_learning_object_detection_yolo_nas', ckpt_root_dir=CHECKPOINT_DIR)
...
rf = Roboflow(api_key="iaGATsDkbAPBMH4O5pHv")
...
dataset_params = {
    'data_dir': '/home/user/dev/super-gradients/notebooks/data/futbol-players-9', # path to dataset 
    'train_images_dir':'train/images',
    'train_labels_dir':'train/labels',
    'val_images_dir':'valid/images',
    'val_labels_dir':'valid/labels',
    'classes': ['0', '1', '2'] # labels here 
}
...
model = models.get("yolo_nas_l", pretrained_weights="coco", num_classes=num_classes)
...
image_path = '/home/user/dev/super-gradients/notebooks/data/futbol-players-9/valid/images/yt1s-com-Resume-Liverpool-01-Burnley-Premier-League-J18-fps-2_00057_jpeg_jpg.rf.8d4b242e459a3bba0e6958d7e4cea6ed.jpg'
